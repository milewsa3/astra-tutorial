          ...
          <div className="flex flex-col items-center justify-center py-20 w-full">
            ...
            <div className="flex flex-col items-center mt-8 max-w-3xl mx-auto w-11/12 md:w-full">
              ...
              <div className="hidden md:flex relative items-center justify-center mt-8 md:mt-12 w-full">
                ...
                >
                  <p className="text-foreground text-sm text-center md:text-base font-medium pl-4 pr-4 lg:marker:pr-8">
            ...
            <div className="relative flex items-center justify-center mx-auto py-10 md:py-20 w-full">
              <div className="absolute top-1/2 left-1/2 -z10 gradient w-3/4 -translate-x-1/2 -translate-y-1/2 h-3/4 inset-0 blur-[1rem]"></div>
